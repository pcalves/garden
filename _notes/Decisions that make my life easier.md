...
Life is a never-ending barrage of choices, decisions and compromises. The following is a list of decisions that I've made. Once you decide on something you can let it go, or rather let it become a part of you, and reduce the number of choices. Inspired by [[./External/Steph Ango|Steph Ango]]'s [[./Clippings/Style is consistent constraint|Style is consistent constraint]].
...
- For online services, open-source over closed-source, self-hosted whenever possible, [[./Clippings/100% user-supported|100% user-supported]] over VC, paid over free
